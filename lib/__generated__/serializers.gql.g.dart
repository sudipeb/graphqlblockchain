...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(GCompanyData.serializer)
          ..add(GCompanyData_company.serializer)
          ..add(GCompanyData_company_headquarters.serializer)
          ..add(GCompanyData_company_links.serializer)
          ..add(GCompanyReq.serializer)
          ...
          ..addBuilderFactory(
            ...
            () => ListBuilder<Gusers_insert_input>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(Gusers_update_column),
            ]),
            () => ListBuilder<Gusers_update_column>(),
          )
          ..addBuilderFactory(
