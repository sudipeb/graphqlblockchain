...
part of 'get_rocket_details.var.gql.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<GRocketsVars> _$gRocketsVarsSerializer = _$GRocketsVarsSerializer();
...
class _$GRocketsVars extends GRocketsVars {
  ...
  @override
  GRocketsVarsBuilder toBuilder() => GRocketsVarsBuilder()..replace(this);
...
class GRocketsVarsBuilder
  ...
  _$GRocketsVars _build() {
    final _$result = _$v ?? _$GRocketsVars._();
    replace(_$result);
    return _$result;
  }
}
